@extends('template')
@section('konten')
    <div class="bg-gray-100 dashboard flex">
        <!-- Dashboard Menu -->
        <div class="bg-gray-100 w-2/12 h-screen capitalize items-center justify-center text-center">
            <a href="{{ url('/') }}">
            ...
            <div class="form p-4">
                <table action="" class="text-center border-2 w-full">
                    <thead id="nav-data" class="nav-data">
                        ...
                        <th class="font-bold border-2 py-1">golongan</th>
                        <th class="font-bold border-2 py-1">pemakaian minimum</th>
                    ...
                    @foreach ($data_pks as $item)
                        <tbody id="data" class="data">
                            ...
                            <td class="border-2 py-1">{{ $item->golongan }}</td>
